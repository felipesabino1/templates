// Verificar no insert de intervalos qual tipo de merge que deve considerar [l,r]\cup[r+1,r2] vira [l,r2] ou se nao.
...
struct STI{
    ...
    void insert(TT l, TT r){
        ...
        while(!st.empty() && it != st.begin()){
            it--;
            #warning escolher qual o merge certo
            // [l1,r1]\cup[r1+1,r2] == (l1,r2)
            // if(it->r < l-1) break;

            // [l1,r1]\cup[r1+1,r2] == [l1,r1]\cup[r1+1,r2]
            if(it->r < l) break;
